...
%% @author Thorsten Schuett <schuett@zib.de>
%% @copyright 2008 Konrad-Zuse-Zentrum fuer Informationstechnik Berlin
%% @version $Id: cs_replica_stabilization.erl 958 2010-08-03 13:53:28Z kruber@zib.de $
-module(cs_replica_stabilization).

-author('schuett@zib.de').
-vsn('$Id: cs_replica_stabilization.erl 958 2010-08-03 13:53:28Z kruber@zib.de $').
